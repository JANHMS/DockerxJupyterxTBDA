...
c.NotebookApp.allow_origin = u'intense-eyrie-56604.herokuapp.com/' # put your public IP Address here
c.NotebookApp.ip = '*'
c.NotebookApp.allow_remote_access = True
c.NotebookApp.open_browser = False

# ipython -c "from notebook.auth import passwd; passwd()"
c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$W/p+raxM6y5auWIpTwcTBA$pcsaGNV/QoYB0xCC+sjTKQ'
